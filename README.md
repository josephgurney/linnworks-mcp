...
![Version](https://img.shields.io/badge/version-1.55.4-blue)
...
| `cancel_order` | Cancel an open (unprocessed) order. ⚠️ v1.55.1 fixed a bug that meant this had never worked: `Orders/CancelOrder` requires `refund`, which the tool never sent, and omitting it returns a bare "The request is invalid." Live-proven 18 Sep 2026 — cancelling releases the allocated stock |
